...
console.log('📰 Importing ACT Main Blog Articles to Enrichment System\n');
...
async function importArticles() {
  ...
  for (const article of published) {
    try {
      ...
      const author = article.fieldData?.['author-name'] || 'ACT Team';
      ...
      const enrichment = {
        project_slug: 'act-main',
        project_title: 'A Curious Tractor',
        enrichment_type: 'blog_links',
        ai_generated: {
          title,
          slug,
          excerpt,
          url: `https://act.place/blog/${slug}`,
          featuredImage,
          tags,
          author,
          publishedDate,
