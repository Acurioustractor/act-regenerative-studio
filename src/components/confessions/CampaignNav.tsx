...
export function CampaignNav() {
  ...
  return (
    <nav
      ...
      className="full-bleed relative z-40 flex flex-wrap items-center justify-center gap-x-2 gap-y-2 border-b border-[var(--warm-earth)] bg-[#15100A]/95 px-4 pb-3 pt-5 backdrop-blur-sm md:pt-6"
    >
          ...
          <Link
            ...
            className={`rounded-full border px-3.5 py-1.5 font-[var(--font-sans)] text-[11px] font-semibold uppercase tracking-[0.16em] transition-colors ${
              active
                ...
                : 'border-transparent text-[#9A8C73] hover:border-[var(--warm-bark-deep)] hover:text-[#E4D8C4]'
            }`}
          >
            {it.label}
          </Link>
