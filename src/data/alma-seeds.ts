...
export const REAL_INITIATIVES: Initiative[] = [
    ...
    { title: 'SMART HCP GP Uplift Project', slug: 'smart-hcp-uplift', type: 'Studio', description: 'Primary care referral and uplift workstream.', status: 'active', outcome_focus: 'Healthcare integration, referral pathways', community_authority: 'Low', evidence_strength: 'Medium', context_tags: ['Health', 'SMART', 'System Integration', 'Research/R&D'] },
